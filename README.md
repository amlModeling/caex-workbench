...
We added the variability functionality to the AutomationML environment using the [*VERSO* tool](https://github.com/antoniogarmendia/ecore-product-line). The project example is [*caex.caex30.feature.variability.ppu*](examples/caex30/caex.caex30.feature.variability.ppu)
