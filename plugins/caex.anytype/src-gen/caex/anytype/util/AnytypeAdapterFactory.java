...
public class AnytypeAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected AnytypeSwitch<Adapter> modelSwitch = new AnytypeSwitch<Adapter>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link caex.anytype.GenericAttribute <em>Generic Attribute</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
