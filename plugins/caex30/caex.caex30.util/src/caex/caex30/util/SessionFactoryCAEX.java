...
/*
 * This class is specific for the CAEX editor
 * It is the same implementation as the default one, just change a little bit 
 * the method: createSession
 * */
